\documentclass[a4paper]{article}
    ...
    \aux{cantidadTotalDePosiciones}{t: toroide}{\ent}{
        cols(t) $\times$ rows(t)
    }
    ...
    \pred{areaQueCubrePosVivasIncrementa}{t: toroide}{
        \Existe{t_{1}}{toroide}((esToroideValido(t$_{1}$) \yLuego esEvolucion(t$_{1}$, t)) $\wedge$ \bt
    ...
    \pred{tienePeriodicidad}{t: toroide}{
        \Existe{k}{\ent}(tienePeriodicidadK-Esima(t, k))
    }
