\documentclass[a4paper]{article}
    ...
    \begin{proc}{enCrecimiento}{
            ...
            \Out res: \bool}{}
        \pre{esToroideValido(t)}
        \post{res = \True \Iff areaQueCubreIncrementa(t)}
    \end{proc}
    ...
    \pred{areaQueCubreIncrementa}{t: toroide}{
        \Existe{t_{1}}{toroide}((esToroideValido(t_{1}) \yLuego esEvolucion(t_{1}, t)) \wedge \bt
        \Existe{a, a_{1}}{\ent} \btt
            ((esAreaValida(t, a) \wedge esAreaValida(t, a_{1})) \yLuego \bttt
                (esMinimaAreaQueCubrePosVivas(t, a) \wedge \bttt
                esMinimaAreaQueCubrePosVivas(t_{1}, a_{1}) \wedge \bttt
                a < a_{1})))
    }
    ...
    \pred{esAreaQueCubrePosVivas}{t: toroide, a: \ent}{
        \Existe{t_{d}}{toroide}
            ((esToroideValido(t_{d}) \yLuego esTraslacion(t_{d}, t)) \wedge \btt 
            (\Existe{m}{\matriz{T}} (esMatriz(m) \yLuego \bttt
                (area(m) = a \wedge cubrePosicionesVivas(t_{d}, m)))))
    }
    ...
    \pred{cubrePosicionesVivas}{t: toroide, m: \matriz{T}}{
        \Existe{e}{\tEnt} (esDesfazajeValido(e, m, t) \yLuego \btt
            (\forAll{p}{\tEnt}
    ...
    \pred{esDesfazajeValido}{e: \tEnt,\ m: \matriz{T},\ t: toroide}{
        (0 \leq r_{0} + cols(m) \leq cols(t)) \wedge \bt
        (0 \leq r_{1} + rows(m) \leq rows(t))
    }
