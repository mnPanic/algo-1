\documentclass[a4paper]{article}
    ...
    \begin{proc}{seleccionNatural}{
            ...
            \Out res: \ent}{}
        \pre{/*TODO*/}
        \post{(0 \leq res < \longitud{ts}) \yLuego (
              noMuere(ts[res]) \vee
    ...
    \pred{muereDespues}{t, w: toroide}{
        (\exists{\ n, m : \ent})\ (muereEnTicks(t, n) \wedge muereEnTicks(w, m) \wedge (n \geq m))
    }
    
    % un toroide t muere en n ticks, si en el tick n esta muerto y para todo k <= n, esta vivo en k
    \pred{muereEnTicks}{}{}
    ...
    % para todo i en rango de la lista van a existir k, m ticks en los cuales t[i] y t[res] respectivamente mueren, y se cumple que m >= k
    % (V i : Z) enRango(i) -> 
    % // [Tres tiene periodicidad)]
    % (O)
    %(E k, m : Z) tq (muereEnTicks(t[i], k) && muereEnTicks(t[res], m)) y m >= k 
