\documentclass[a4paper]{article}
    ...
    \begin{proc}{evolucionToroide}{
        ...
        TODO: sacar el es toroide valido de t adentro de esEvolucion
    ...
    \pred{muereDespues}{t, w: toroide}{
        (\exists{\ n, m : \ent})\ (muereEnTick(t, n) \wedge muereEnTick(w, m) \wedge (n \geq m))
    }
    ...
    \pred{esMinimaPeriodicidad}{t: $toroide$, p: \ent}{
        ...
        \forAll{p}{\ent} ($tienePeriodicidadK-Esima(t, q) $ \implica p \leq q)
    }
